...
public:
    ...
    void on_bar(const Bar& bar) override {
        ...
        if ((signed_position_size() > 0)) {
            strategy_exit(std::string("LX"), std::string("L"), na<double>(), na<double>(), trailPts, trailOff, na<double>(), 100.0, std::string("trail long"), na<double>(), "");
        }
        if ((signed_position_size() < 0)) {
            strategy_exit(std::string("SX"), std::string("S"), na<double>(), na<double>(), trailPts, trailOff, na<double>(), 100.0, std::string("trail short"), na<double>(), "");
        }
