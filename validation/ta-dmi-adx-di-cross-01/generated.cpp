...
public:
    ...
    explicit GeneratedStrategy() : _ta_dmi_1(14, 14) {
    ...
    void on_bar(const Bar& bar) override {
        ...
        double diPlus = _result__ta_dmi_1.diplus;
        double diMinus = _result__ta_dmi_1.diminus;
        double adxVal = _result__ta_dmi_1.adx;
        bullCross = (is_first_tick_ ? _ta_crossover_2.compute(diPlus, diMinus) : _ta_crossover_2.recompute(diPlus, diMinus));
        bearCross = (is_first_tick_ ? _ta_crossunder_3.compute(diPlus, diMinus) : _ta_crossunder_3.recompute(diPlus, diMinus));
        if (bullCross) {
