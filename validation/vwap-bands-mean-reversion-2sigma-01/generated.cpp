...
public:
    ...
    void on_bar(const Bar& bar) override {
        ...
        long_condition = (is_first_tick_ ? _ta_crossunder_2.compute(current_bar_.close, lower_band) : _ta_crossunder_2.recompute(current_bar_.close, lower_band));
        exit_condition = (is_first_tick_ ? _ta_crossover_3.compute(current_bar_.close, vw) : _ta_crossover_3.recompute(current_bar_.close, vw));
        if (long_condition) {
