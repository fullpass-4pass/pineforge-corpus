...
public:
    ...
    explicit GeneratedStrategy() : _ta_sma_1(20), entries(0) {
    ...
    void on_bar(const Bar& bar) override {
        ...
        if (is_na(lv)) {
            lv = pf_line_new(_pf_lines_, (int64_t)(bar_index_), (double)(sma), (int64_t)(bar_index_), (double)(sma), XLoc::bar_index, false, false);
        } else {
