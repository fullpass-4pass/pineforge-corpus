...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::fastEma) _pf_value_6;
        decltype(GeneratedStrategy::slowEma) _pf_value_7;
        decltype(GeneratedStrategy::turnLong) _pf_value_8;
        decltype(GeneratedStrategy::turnShort) _pf_value_9;
    ...
    void restore_script_state() override {
        ...
        this->fastEma = _pf_script_state_checkpoint_->_pf_value_6;
        this->slowEma = _pf_script_state_checkpoint_->_pf_value_7;
        this->turnLong = _pf_script_state_checkpoint_->_pf_value_8;
        this->turnShort = _pf_script_state_checkpoint_->_pf_value_9;
    ...
    explicit GeneratedStrategy() : _ta_ema_1(31), _ta_ema_2(97) {
    ...
    void on_bar(const Bar& bar) override {
        if (!_inputs_initialized_) {
            fastLength = get_input_int("Fast EMA", 31);
            slowLength = get_input_int("Slow EMA", 97);
            _inputs_initialized_ = true;
        }
        if (!_ta_initialized_) {
            _ta_ema_1 = ta::EMA(get_input_int("Fast EMA", 31));
            _ta_ema_2 = ta::EMA(get_input_int("Slow EMA", 97));
