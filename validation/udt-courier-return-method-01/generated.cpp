...
inline bool is_na(const CourierEnvelope& _z) { return _z.__pf_id < 0; }
...
struct _PFUdtRecord_CourierEnvelope {
    double center = 0.0;
    double width = 0.0;
    int64_t createdAt = 0;
};
...
template <>
struct _PFCheckpointTraits<_PFUdtRecord_CourierEnvelope> {
    struct snapshot_type {
        _PFCheckpointTraits<decltype(_PFUdtRecord_CourierEnvelope::center)>::snapshot_type _pf_field_0;
        _PFCheckpointTraits<decltype(_PFUdtRecord_CourierEnvelope::width)>::snapshot_type _pf_field_1;
        _PFCheckpointTraits<decltype(_PFUdtRecord_CourierEnvelope::createdAt)>::snapshot_type _pf_field_2;
    };
    static snapshot_type take(const _PFUdtRecord_CourierEnvelope& value) {
        return snapshot_type{
            _PFCheckpointTraits<decltype(_PFUdtRecord_CourierEnvelope::center)>::take(value.center),
            _PFCheckpointTraits<decltype(_PFUdtRecord_CourierEnvelope::width)>::take(value.width),
            _PFCheckpointTraits<decltype(_PFUdtRecord_CourierEnvelope::createdAt)>::take(value.createdAt),
        };
    }
    static void restore(_PFUdtRecord_CourierEnvelope& value, const snapshot_type& snapshot) {
        _PFCheckpointTraits<decltype(_PFUdtRecord_CourierEnvelope::center)>::restore(value.center, snapshot._pf_field_0);
        _PFCheckpointTraits<decltype(_PFUdtRecord_CourierEnvelope::width)>::restore(value.width, snapshot._pf_field_1);
        _PFCheckpointTraits<decltype(_PFUdtRecord_CourierEnvelope::createdAt)>::restore(value.createdAt, snapshot._pf_field_2);
    }
};

template <>
struct _PFCheckpointTraits<_PFUdtArena<CourierEnvelope, _PFUdtRecord_CourierEnvelope>> {
    using arena_type = _PFUdtArena<CourierEnvelope, _PFUdtRecord_CourierEnvelope>;
...
public:
    ...
    _PFUdtArena<CourierEnvelope, _PFUdtRecord_CourierEnvelope> _pf_udt_CourierEnvelope{&_pf_udt_undo};
    ta::EMA _ta_ema_1;
    ta::ATR _ta_atr_2;
    ...
    CourierEnvelope activeEnvelope = CourierEnvelope{};
    double upperBoundary = 0.0;
    bool ageIsValid = false;
    bool enterLong = false;
    bool envelopeEnded = false;
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_CourierEnvelope)>::snapshot_type _pf_value_1;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::rangeLength)>::snapshot_type _pf_value_6;
        _PFCheckpointTraits<decltype(GeneratedStrategy::entryMultiplier)>::snapshot_type _pf_value_7;
        _PFCheckpointTraits<decltype(GeneratedStrategy::maximumAtrLoss)>::snapshot_type _pf_value_8;
        _PFCheckpointTraits<decltype(GeneratedStrategy::activeEnvelope)>::snapshot_type _pf_value_9;
        _PFCheckpointTraits<decltype(GeneratedStrategy::upperBoundary)>::snapshot_type _pf_value_10;
        _PFCheckpointTraits<decltype(GeneratedStrategy::ageIsValid)>::snapshot_type _pf_value_11;
        _PFCheckpointTraits<decltype(GeneratedStrategy::enterLong)>::snapshot_type _pf_value_12;
        _PFCheckpointTraits<decltype(GeneratedStrategy::envelopeEnded)>::snapshot_type _pf_value_13;
        _PFCheckpointTraits<decltype(GeneratedStrategy::riskExceeded)>::snapshot_type _pf_value_14;
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_CourierEnvelope)>::take(_pf_udt_CourierEnvelope),
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::rangeLength)>::take(rangeLength),
            _PFCheckpointTraits<decltype(GeneratedStrategy::entryMultiplier)>::take(entryMultiplier),
            _PFCheckpointTraits<decltype(GeneratedStrategy::maximumAtrLoss)>::take(maximumAtrLoss),
            _PFCheckpointTraits<decltype(GeneratedStrategy::activeEnvelope)>::take(activeEnvelope),
            _PFCheckpointTraits<decltype(GeneratedStrategy::upperBoundary)>::take(upperBoundary),
            _PFCheckpointTraits<decltype(GeneratedStrategy::ageIsValid)>::take(ageIsValid),
            _PFCheckpointTraits<decltype(GeneratedStrategy::enterLong)>::take(enterLong),
            _PFCheckpointTraits<decltype(GeneratedStrategy::envelopeEnded)>::take(envelopeEnded),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_CourierEnvelope)>::restore(this->_pf_udt_CourierEnvelope, _pf_script_state_checkpoint_->_pf_value_1);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::rangeLength)>::restore(this->rangeLength, _pf_script_state_checkpoint_->_pf_value_6);
        _PFCheckpointTraits<decltype(GeneratedStrategy::entryMultiplier)>::restore(this->entryMultiplier, _pf_script_state_checkpoint_->_pf_value_7);
        _PFCheckpointTraits<decltype(GeneratedStrategy::maximumAtrLoss)>::restore(this->maximumAtrLoss, _pf_script_state_checkpoint_->_pf_value_8);
        _PFCheckpointTraits<decltype(GeneratedStrategy::activeEnvelope)>::restore(this->activeEnvelope, _pf_script_state_checkpoint_->_pf_value_9);
        _PFCheckpointTraits<decltype(GeneratedStrategy::upperBoundary)>::restore(this->upperBoundary, _pf_script_state_checkpoint_->_pf_value_10);
        _PFCheckpointTraits<decltype(GeneratedStrategy::ageIsValid)>::restore(this->ageIsValid, _pf_script_state_checkpoint_->_pf_value_11);
        _PFCheckpointTraits<decltype(GeneratedStrategy::enterLong)>::restore(this->enterLong, _pf_script_state_checkpoint_->_pf_value_12);
        _PFCheckpointTraits<decltype(GeneratedStrategy::envelopeEnded)>::restore(this->envelopeEnded, _pf_script_state_checkpoint_->_pf_value_13);
        _PFCheckpointTraits<decltype(GeneratedStrategy::riskExceeded)>::restore(this->riskExceeded, _pf_script_state_checkpoint_->_pf_value_14);
    ...
    explicit GeneratedStrategy() : _ta_ema_1(37), _ta_atr_2(16) {
    ...
    double _udt_CourierEnvelope_upperGate(CourierEnvelope self, double multiplier) {
        return (_pf_udt_CourierEnvelope.read(self).center + (_pf_udt_CourierEnvelope.read(self).width * multiplier));
    }
    ...
    CourierEnvelope buildEnvelope_cs0(double source, int centerLength, int rangeLength) {
        ...
        double widthValue = (history_advances_new_bar() ? _ta_atr_2.compute(current_bar_.high, current_bar_.low, current_bar_.close) : _ta_atr_2.recompute(current_bar_.high, current_bar_.low, current_bar_.close));
    ...
    void on_bar(const Bar& bar) override {
        if (!_inputs_initialized_) {
            centerLength = get_input_int("Envelope Center Length", 37);
            rangeLength = get_input_int("Envelope Range Length", 16);
            entryMultiplier = get_input_double("Entry Width", 1.15);
            maximumAtrLoss = get_input_double("Maximum ATR Loss", 2.4);
            _inputs_initialized_ = true;
        }
        if (!_ta_initialized_) {
            _ta_ema_1 = ta::EMA(get_input_int("Envelope Center Length", 37));
            _ta_atr_2 = ta::ATR(get_input_int("Envelope Range Length", 16));
            _ta_initialized_ = true;
        }
        activeEnvelope = buildEnvelope_cs0(current_bar_.close, centerLength, rangeLength);
        upperBoundary = _udt_CourierEnvelope_upperGate(activeEnvelope, entryMultiplier);
        ageIsValid = ([&]{ auto _pna_l = ((pine_bar_index() - _pf_udt_CourierEnvelope.read(activeEnvelope).createdAt)); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }());
        enterLong = (ageIsValid && (history_advances_new_bar() ? _ta_crossover_3.compute(current_bar_.close, upperBoundary) : _ta_crossover_3.recompute(current_bar_.close, upperBoundary)));
        envelopeEnded = ([&]{ auto _pna_l = (current_bar_.close); auto _pna_r = (_pf_udt_CourierEnvelope.read(activeEnvelope).center); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) && !_pfc_eq); }());
        riskExceeded = (([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()) && ([&]{ auto _pna_l = (current_bar_.close); auto _pna_r = (((signed_position_size() == 0.0 ? na<double>() : position_entry_price_) - (_pf_udt_CourierEnvelope.read(activeEnvelope).width * maximumAtrLoss))); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) && !_pfc_eq); }()));
        if ((([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }()) && enterLong)) {
            strategy_entry(std::string("Courier Long"), true, na<double>(), na<double>(), na<double>(), "");
        } else
        if ((([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()) && (envelopeEnded || riskExceeded))) {
            strategy_close(std::string("Courier Long"), ((riskExceeded) ? (std::string("ATR risk")) : (std::string("Envelope ended"))), na<double>(), na<double>(), false, 184683593747ULL);
        }
    }
