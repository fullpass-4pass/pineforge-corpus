...
public:
    ...
    void on_bar(const Bar& bar) override {
        ...
        entryCond = (is_first_tick_ ? _ta_crossover_3.compute(emaFast, emaSlow) : _ta_crossover_3.recompute(emaFast, emaSlow));
        ...
        if ((entryCond && (signed_position_size() == 0))) {
            ...
            stopLvl = (current_bar_.open + ((current_bar_.high - current_bar_.open) * 0.5));
