...
public:
    ...
    int atrLength = 0;
    int revisionBars = 0;
    double wideStopAtr = 0.0;
    double wideTargetAtr = 0.0;
    double narrowStopAtr = 0.0;
    double narrowTargetAtr = 0.0;
    double fastLine = 0.0;
    double slowLine = 0.0;
    double atrValue = 0.0;
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::admittedAt) _pf_value_5;
        ...
        decltype(GeneratedStrategy::revisionBars) _pf_value_10;
        decltype(GeneratedStrategy::wideStopAtr) _pf_value_11;
        decltype(GeneratedStrategy::wideTargetAtr) _pf_value_12;
        decltype(GeneratedStrategy::narrowStopAtr) _pf_value_13;
        decltype(GeneratedStrategy::narrowTargetAtr) _pf_value_14;
        ...
        decltype(GeneratedStrategy::heldBars) _pf_value_19;
    ...
    void restore_script_state() override {
        ...
        this->admittedAt = _pf_script_state_checkpoint_->_pf_value_5;
        ...
        this->revisionBars = _pf_script_state_checkpoint_->_pf_value_10;
        this->wideStopAtr = _pf_script_state_checkpoint_->_pf_value_11;
        this->wideTargetAtr = _pf_script_state_checkpoint_->_pf_value_12;
        this->narrowStopAtr = _pf_script_state_checkpoint_->_pf_value_13;
        this->narrowTargetAtr = _pf_script_state_checkpoint_->_pf_value_14;
        ...
        this->heldBars = _pf_script_state_checkpoint_->_pf_value_19;
    ...
    explicit GeneratedStrategy() : _ta_ema_1(20), _ta_ema_2(61), _ta_atr_3(17), admittedAt(na<int>()) {
    ...
    void on_bar(const Bar& bar) override {
        ...
        if (!_inputs_initialized_) {
            ...
            revisionBars = get_input_int("Revision Hold Bars", 14);
            wideStopAtr = get_input_double("Initial Stop ATR", 2.8);
            wideTargetAtr = get_input_double("Initial Target ATR", 4.2);
        ...
        if (!_ta_initialized_) {
            ...
            _ta_ema_2 = ta::EMA(get_input_int("Slow EMA Length", 61));
        ...
        if ((([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }()) && enterLong)) {
            strategy_entry(std::string("Revision Long"), true, na<double>(), na<double>(), na<double>(), "");
        }
        ...
        heldBars = ((is_na(admittedAt)) ? (0) : ((pine_bar_index() - admittedAt)));
        if ((([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()) && ([&]{ auto _pna_l = (heldBars); auto _pna_r = (revisionBars); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l < _pna_r); }()))) {
            strategy_exit(std::string("Revision Guard"), std::string("Revision Long"), ((signed_position_size() == 0.0 ? na<double>() : position_entry_price_) + (atrValue * wideTargetAtr)), ((signed_position_size() == 0.0 ? na<double>() : position_entry_price_) - (atrValue * wideStopAtr)), na<double>(), na<double>(), na<double>(), 100.0, std::string("Initial bracket"), na<double>(), "", na<double>(), na<double>());
        } else
        if (([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }())) {
            strategy_exit(std::string("Revision Guard"), std::string("Revision Long"), ((signed_position_size() == 0.0 ? na<double>() : position_entry_price_) + (atrValue * narrowTargetAtr)), ((signed_position_size() == 0.0 ? na<double>() : position_entry_price_) - (atrValue * narrowStopAtr)), na<double>(), na<double>(), na<double>(), 100.0, std::string("Revised bracket"), na<double>(), "", na<double>(), na<double>());
        }
        if ((([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()) && (history_advances_new_bar() ? _ta_crossunder_5.compute(fastLine, slowLine) : _ta_crossunder_5.recompute(fastLine, slowLine)))) {
            strategy_close(std::string("Revision Long"), std::string("Trend ended"), na<double>(), na<double>(), false, 214748364819ULL);
        }
    }
