...
public:
    ...
    int fastLength = 0;
    int slowLength = 0;
    double fullQuantity = 0.0;
    double recoveryQuantity = 0.0;
    int atrLength = 0;
    double maximumAtrLoss = 0.0;
    double fastLine = 0.0;
    double slowLine = 0.0;
    double atrValue = 0.0;
    double nextQuantity = 0.0;
    double lastClosedIndex = 0.0;
    double lastRealizedProfit = 0.0;
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::fullQuantity) _pf_value_7;
        decltype(GeneratedStrategy::recoveryQuantity) _pf_value_8;
        ...
        decltype(GeneratedStrategy::nextQuantity) _pf_value_14;
        decltype(GeneratedStrategy::lastClosedIndex) _pf_value_15;
        decltype(GeneratedStrategy::lastRealizedProfit) _pf_value_16;
        decltype(GeneratedStrategy::enterLong) _pf_value_17;
        decltype(GeneratedStrategy::trendEnded) _pf_value_18;
    ...
    void restore_script_state() override {
        ...
        this->fullQuantity = _pf_script_state_checkpoint_->_pf_value_7;
        this->recoveryQuantity = _pf_script_state_checkpoint_->_pf_value_8;
        ...
        this->nextQuantity = _pf_script_state_checkpoint_->_pf_value_14;
        this->lastClosedIndex = _pf_script_state_checkpoint_->_pf_value_15;
        this->lastRealizedProfit = _pf_script_state_checkpoint_->_pf_value_16;
        this->enterLong = _pf_script_state_checkpoint_->_pf_value_17;
        this->trendEnded = _pf_script_state_checkpoint_->_pf_value_18;
    ...
    explicit GeneratedStrategy() : _ta_ema_1(17), _ta_ema_2(49), _ta_atr_3(16) {
    ...
    void on_bar(const Bar& bar) override {
        if (!_inputs_initialized_) {
            fastLength = get_input_int("Fast EMA Length", 17);
            slowLength = get_input_int("Slow EMA Length", 49);
            fullQuantity = get_input_double("Full Quantity", 2.0);
            recoveryQuantity = get_input_double("Recovery Quantity", 1.0);
