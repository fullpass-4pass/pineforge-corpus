...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::openedBar) _pf_value_3;
        decltype(GeneratedStrategy::_strat_position_size) _pf_value_4;
        decltype(GeneratedStrategy::signalLength) _pf_value_5;
        decltype(GeneratedStrategy::holdBars) _pf_value_6;
        decltype(GeneratedStrategy::atrLength) _pf_value_7;
        decltype(GeneratedStrategy::stopAtr) _pf_value_8;
        decltype(GeneratedStrategy::signalAverage) _pf_value_9;
        decltype(GeneratedStrategy::atrValue) _pf_value_10;
        decltype(GeneratedStrategy::enterLong) _pf_value_11;
        decltype(GeneratedStrategy::timeExpired) _pf_value_12;
    ...
    void restore_script_state() override {
        ...
        this->openedBar = _pf_script_state_checkpoint_->_pf_value_3;
        this->_strat_position_size = _pf_script_state_checkpoint_->_pf_value_4;
        this->signalLength = _pf_script_state_checkpoint_->_pf_value_5;
        this->holdBars = _pf_script_state_checkpoint_->_pf_value_6;
        this->atrLength = _pf_script_state_checkpoint_->_pf_value_7;
        this->stopAtr = _pf_script_state_checkpoint_->_pf_value_8;
        this->signalAverage = _pf_script_state_checkpoint_->_pf_value_9;
        this->atrValue = _pf_script_state_checkpoint_->_pf_value_10;
        this->enterLong = _pf_script_state_checkpoint_->_pf_value_11;
        this->timeExpired = _pf_script_state_checkpoint_->_pf_value_12;
    ...
    explicit GeneratedStrategy() : _ta_sma_1(34), _ta_atr_2(14), openedBar(na<int>()) {
    ...
    void on_bar(const Bar& bar) override {
        ...
        signalAverage = (history_advances_new_bar() ? _ta_sma_1.compute(current_bar_.close) : _ta_sma_1.recompute(current_bar_.close));
        ...
        enterLong = (history_advances_new_bar() ? _ta_crossover_3.compute(current_bar_.close, signalAverage) : _ta_crossover_3.recompute(current_bar_.close, signalAverage));
        if ((enterLong && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }()))) {
            strategy_entry(std::string("Horizon Long"), true, na<double>(), na<double>(), na<double>(), "");
        }
        if ((([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()) && ([&]{ auto _pna_l = (_strat_position_size[1]); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) || _pfc_eq); }()))) {
            openedBar = pine_bar_index();
        }
        timeExpired = ((([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()) && !(is_na(openedBar))) && ([&]{ auto _pna_l = ((pine_bar_index() - openedBar)); auto _pna_r = (holdBars); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) || _pfc_eq); }()));
        if (timeExpired) {
            strategy_close(std::string("Horizon Long"), std::string("Deterministic time exit"), na<double>(), na<double>(), false, 133143986195ULL);
        }
        if (([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }())) {
            strategy_exit(std::string("Horizon Stop"), std::string("Horizon Long"), na<double>(), ((signed_position_size() == 0.0 ? na<double>() : position_entry_price_) - (atrValue * stopAtr)), na<double>(), na<double>(), na<double>(), 100.0, "", na<double>(), "", na<double>(), na<double>());
        }
