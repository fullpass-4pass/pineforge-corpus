...
public:
    ...
    void on_bar(const Bar& bar) override {
        ...
        longCond = ((is_first_tick_ ? _ta_crossover_5.compute(emaFast, emaSlow) : _ta_crossover_5.recompute(emaFast, emaSlow)) && (rsiVal < 70));
        shortStop = (is_first_tick_ ? _ta_crossunder_6.compute(rsiVal, 50) : _ta_crossunder_6.recompute(rsiVal, 50));
        if (longCond) {
